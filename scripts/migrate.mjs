...
const targetClient = createClient({
  projectId: "2ssfzxat", // Your Sanity project ID
  dataset: "production", // Default to "production" if not set
  useCdn: false, // Disable CDN for real-time updates
  apiVersion: "2023-01-01", // Sanity API version
  token: "sk42Ryar8llsbt2M1fUv6RuGXfX7eGEgG1wu5DY5ItfpXWy8RrpoTNmJ9zIUCfQt1Dxm5yFZ5OMotkqAJFwItZY7Bk3zB9tQTZaPQ2BKLbuOfOrw8zB4d1Qx1JFHge9j45vXTejXQesXHGGaFjZRf2ak9RMchVyqmfbQ0rdF8RoIx6TMeRV3", // API token for authentication
});
